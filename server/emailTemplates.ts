...
const translations = {
  ...
  hr: {
    accountTypes: {
      personal: "fizička osoba",
      business: "poduzetnik/tvrtka"
    },
    verification: {
      subject: "Potvrdite svoju e-mail adresu - KreditPass",
      tagline: "Rješenja financiranja",
      greeting: "Pozdrav",
      thankYou: "Hvala što ste se registrirali na KreditPass kao",
      instruction: "Za aktivaciju računa i pristup našim uslugama financiranja, potvrdite svoju e-mail adresu klikom na gumb ispod:",
      buttonText: "Potvrdi moj e-mail",
      alternativeText: "Ako gumb ne radi, kopirajte i zalijepite ovaj link u vaš preglednik:",
      disclaimerText: "Ako niste stvorili račun na KreditPass, možete zanemariti ovaj e-mail.",
      footer: "Sva prava pridržana.",
      textVersion: {
        thankYou: "Hvala što ste se registrirali na KreditPass kao",
        instruction: "Za aktivaciju računa, potvrdite svoju e-mail adresu posjetom ovom linku:",
        disclaimer: "Ako niste stvorili račun na KreditPass, možete zanemariti ovaj e-mail.",
        signature: "KreditPass - Rješenja financiranja"
      }
    },
    welcome: {
      subject: "Dobrodošli na KreditPass!",
      headerTitle: "🎉 Dobrodošli na KreditPass!",
      greeting: "Pozdrav",
      verifiedMessage: "Vaša e-mail adresa uspješno je potvrđena! Vaš račun",
      activeMessage: "je sada aktivan.",
      featuresIntro: "Od sada možete pristupiti svim našim funkcijama:",
      features: [
        "Zatražite osobni ili poslovni kredit",
        "Upravljajte otplatama",
        "Vršite prijenose",
        "Pregledajte svoju nadzornu ploču"
      ],
      buttonText: "Prijava",
      supportText: "Naš tim je na raspolaganju za sva vaša pitanja.",
      footer: "Sva prava pridržana."
    },
    contract: {
      subject: "Vaš ugovor o kreditu je dostupan - KreditPass",
      headerTitle: "🎉 Čestitamo!",
      headerSubtitle: "Vaš kredit je odobren",
      greeting: "Pozdrav",
      approvedMessage: "Odlične vijesti! Vaš zahtjev za kredit u iznosu od",
      approvedMessage2: "je odobren.",
      contractReadyTitle: "📄 Vaš ugovor o kreditu je spreman",
      referenceLabel: "Referenca:",
      nextStepsTitle: "Sljedeći koraci:",
      step1Title: "Preuzmite ugovor",
      step1Text: "Preuzmite i pažljivo pročitajte ugovor o kreditu",
      step2Title: "Potpišite dokument",
      step2Text: "Isprintajte, potpišite s napomenom \"Pročitano i odobreno\" praćenom vašim potpisom",
      step3Title: "Vratite potpisani ugovor",
      step3Text: "Učitajte potpisani dokument iz vašeg korisničkog prostora i kliknite na pošalji.",
      downloadButton: "📥 Preuzmi ugovor",
      importantTitle: "⚠️ Važno:",
      importantMessage: "Sredstva će biti deblokirana u roku od nekoliko minuta do maksimalno 24 sata.",
      accessNote: "Ugovoru možete pristupiti i iz vašeg korisničkog prostora u bilo koje vrijeme.",
      contactText: "Imate pitanja? Kontaktirajte nas na support@kreditpass.org",
      footer: "Sva prava pridržana."
    },
    fundingRelease: {
      subject: "Vaša sredstva su deblokirana - KreditPass",
      headerTitle: "✅ Sredstva deblokirana",
      headerSubtitle: "Vaš novac je dostupan",
      greeting: "Pozdrav",
      releaseMessage: "Odlične vijesti! Sredstva vašeg kredita u iznosu od",
      releaseMessage2: "su uspješno deblokirana.",
      referenceLabel: "Referenca kredita:",
      availabilityTitle: "💳 Dostupnost sredstava",
      availabilityText: "Sredstva su sada dostupna na vašem računu i mogu se odmah koristiti.",
      nextStepsTitle: "Što učiniti sada:",
      step1: "Pogledajte stanje na vašoj nadzornoj ploči",
      step2: "Izvršite prijenos na vaš bankovni račun",
      step3: "Upravljajte rokovima otplate",
      dashboardButton: "Pristupite nadzornoj ploči",
      reminderTitle: "📅 Važan podsjetnik",
      reminderText: "Ne zaboravite rokove otplate. Cjeloviti kalendar možete pregledati u vašem korisničkom prostoru.",
      supportText: "Naš tim je na raspolaganju za sva vaša pitanja.",
      contactText: "Imate pitanja? Kontaktirajte nas na",
      footer: "Sva prava pridržana."
    },
    otp: {
      subject: "Kod za provjeru - KreditPass",
      headerTitle: "🔐 Dvofaktorska autentifikacija",
      greeting: "Pozdrav",
      codeTitle: "Vaš kod za provjeru",
      instruction: "Koristite donji kod za prijavu na vaš KreditPass račun:",
      expirationText: "Ovaj kod istječe za 5 minuta.",
      securityWarning: "⚠️ Radi vaše sigurnosti, nikada ne dijelite ovaj kod ni s kim. Naš tim nikada neće tražiti ovaj kod.",
      notYouText: "Ako niste zatražili ovaj kod, zanemarite ovaj e-mail i vaš račun ostaje siguran.",
      footer: "Sva prava pridržana."
    },
    loanRequestUser: {
      subject: "Vaš zahtjev za kredit je primljen - KreditPass",
      headerTitle: "✅ Zahtjev za kredit primljen",
      greeting: "Pozdrav",
      confirmationMessage: "Primili smo vaš zahtjev za kredit",
      confirmationMessage2: "u iznosu od",
      referenceLabel: "Referenca zahtjeva:",
      nextStepsTitle: "Sljedeći koraci:",
      step1: "Naš tim pregledava vaš predmet",
      step2: "Primit ćete odgovor u roku od 24-48 sati",
      step3: "Ako su potrebni dodatni dokumenti, kontaktirat ćemo vas",
      dashboardText: "Status zahtjeva možete pratiti s vaše nadzorne ploče.",
      dashboardButton: "Pristupi mojoj nadzornoj ploči",
      supportText: "Naš tim je na raspolaganju za sva vaša pitanja.",
      footer: "Sva prava pridržana."
    },
    loanRequestAdmin: {
      subject: "Novi zahtjev za kredit - KreditPass",
      headerTitle: "📋 Novi zahtjev za kredit",
      message: "Podnesen je novi zahtjev za kredit koji zahtijeva vašu pažnju.",
      applicantLabel: "Podnositelj:",
      emailLabel: "E-mail:",
      phoneLabel: "Telefon:",
      accountTypeLabel: "Vrsta računa:",
      amountLabel: "Traženi iznos:",
      durationLabel: "Trajanje:",
      loanTypeLabel: "Vrsta kredita:",
      referenceLabel: "Referenca:",
      userIdLabel: "ID korisnika:",
      documentsTitle: "📄 Učitani dokumenti",
      documentTypeLabel: "Vrsta dokumenta",
      downloadLabel: "Preuzmi",
      noDocuments: "Nisu učitani dokumenti",
      monthsLabel: "mjeseci",
      actionButton: "Pregledaj zahtjev",
      footer: "Sva prava pridržana."
    },
    kycUploadedAdmin: {
      subject: "Novi KYC dokument učitan - KreditPass",
      headerTitle: "📄 Novi KYC dokument",
      message: "Učitan je novi KYC dokument koji zahtijeva vašu provjeru.",
      userLabel: "Korisnik:",
      emailLabel: "E-mail:",
      documentTypeLabel: "Vrsta dokumenta:",
      loanTypeLabel: "Vrsta kredita:",
      userIdLabel: "ID korisnika:",
      actionButton: "Provjerite dokument",
      footer: "Sva prava pridržana."
    },
    loanApprovedUser: {
      subject: "Čestitamo! Vaš kredit je odobren - KreditPass",
      headerTitle: "🎉 Čestitamo!",
      headerSubtitle: "Vaš kredit je odobren",
      greeting: "Pozdrav",
      approvalMessage: "Odlične vijesti! Vaš zahtjev za kredit u iznosu od",
      approvalMessage2: "je odobren.",
      referenceLabel: "Referenca:",
      nextStepsTitle: "Sljedeći koraci:",
      step1: "Preuzmite ugovor o kreditu iz vašeg korisničkog prostora",
      step2: "Potpišite ugovor i pošaljite nam ga natrag",
      step3: "Sredstva će biti deblokirana u roku od 24 sata po primitku potpisanog ugovora",
      loginButton: "Pristupite mom korisničkom prostoru",
      importantTitle: "⚠️ Važno:",
      importantMessage: "Morate potpisati i vratiti ugovor kako bi sredstva bila deblokirana.",
      supportText: "Naš tim je na raspolaganju za sva vaša pitanja.",
      footer: "Sva prava pridržana."
    },
    transferInitiatedAdmin: {
      subject: "Novi prijenos iniciran - KreditPass",
      headerTitle: "💸 Novi prijenos iniciran",
      message: "Iniciran je novi prijenos koji zahtijeva vašu pažnju.",
      userLabel: "Korisnik:",
      emailLabel: "E-mail:",
      amountLabel: "Iznos:",
      recipientLabel: "Primatelj:",
      transferIdLabel: "ID prijenosa:",
      userIdLabel: "ID korisnika:",
      actionButton: "Pogledaj prijenos",
      footer: "Sva prava pridržana."
    },
    transferCodeUser: {
      subject: "Kod za validaciju vašeg prijenosa - KreditPass",
      headerTitle: "🔐 Kod za validaciju",
      greeting: "Pozdrav",
      transferInfoTitle: "Detalji prijenosa",
      amountLabel: "Iznos:",
      recipientLabel: "Primatelj:",
      codeTitle: "Vaš kod za validaciju",
      codeSequence: "Kod",
      codeOf: "od",
      instruction: "Koristite donji kod za validaciju vašeg prijenosa:",
      expirationText: "Ovaj kod istječe za 15 minuta.",
      securityWarning: "⚠️ Radi vaše sigurnosti, nikada ne dijelite ovaj kod ni s kim. Naš tim nikada neće tražiti ovaj kod.",
      notYouText: "Ako niste inicirali ovaj prijenos, odmah nas kontaktirajte.",
      footer: "Sva prava pridržana."
    },
    transferCompletedUser: {
      subject: "Vaš prijenos je završen - KreditPass",
      headerTitle: "✅ Prijenos uspješno završen",
      greeting: "Pozdrav",
      congratulationsMessage: "Vaš prijenos je uspješno dovršen nakon validacije svih sigurnosnih kodova.",
      summaryTitle: "📋 Pregled prijenosa",
      amountLabel: "Preneseni iznos:",
      recipientLabel: "Primatelj:",
      ibanLabel: "IBAN primatelja:",
      referenceLabel: "Referenca prijenosa:",
      availabilityTitle: "⏱️ Dostupnost sredstava",
      availabilityMessage: "Sredstva će biti dostupna na računu primatelja u roku od 24 do 72 radna sata, ovisno o bankovnim rokovima.",
      supportTitle: "💬 Trebate pomoć?",
      supportMessage: "Ako naiđete na bilo kakav problem ili imate pitanja o ovom prijenosu, naš tim je na raspolaganju:",
      supportEmail: "Kontaktirajte nas na:",
      thanksMessage: "Hvala vam na povjerenju.",
      footer: "Sva prava pridržana."
    },
    transferCodesAdmin: {
      subject: "Generirani kodovi za prijenos - KreditPass",
      headerTitle: "🔐 Generirani kodovi za validaciju prijenosa",
      message: "Kodovi za prijenos automatski su generirani za sljedeći kredit:",
      userLabel: "Korisnik:",
      amountLabel: "Iznos kredita:",
      loanIdLabel: "Referenca kredita:",
      codesTitle: "📋 Popis kodova za validaciju",
      codeInstruction: "Ručno prenesite ove kodove korisniku u odgovarajućem trenutku. Prijenos će se automatski pauzirati na naznačenim postocima.",
      sequenceLabel: "Kod",
      pauseLabel: "Pauza na",
      contextLabel: "Vrsta",
      importantTitle: "⚠️ Važno:",
      importantMessage: "Ovi kodovi su povjerljivi i NIKADA ne smiju biti automatski poslani. Morate ih ručno prenijeti korisniku jedan po jedan, kako prijenos napreduje.",
      footer: "Sva prava pridržana."
    },
    transferCompletedAdmin: {
      subject: "Izvješće o završenom prijenosu - KreditPass",
      headerTitle: "📊 Prijenos završen - Administratorsko izvješće",
      message: "Prijenos je uspješno završen. Ovdje je detaljno izvješće:",
      userInfoTitle: "👤 Informacije o korisniku",
      userLabel: "Korisnik:",
      emailLabel: "E-mail:",
      userIdLabel: "ID korisnika:",
      transferInfoTitle: "💸 Detalji prijenosa",
      ...
      ibanLabel: "IBAN:",
      transferIdLabel: "ID prijenosa:",
      progressTitle: "✅ Napredak i validacija",
      validationsLabel: "Validirani kodovi:",
      completedAtLabel: "Završeno:",
      actionButton: "Pogledaj sve detalje",
      footer: "Sva prava pridržana."
    }
  }
};
...
export function getRecognitionFeeEmailTemplate(vars: {
  ...
  const translations: Record<string, {
    ...
    fr: {
      ...
      feeExplanation: 'Ces frais correspondent aux frais administratifs de traitement et de reconnaissance de dette liés à votre dossier de financement. Ils sont obligatoires pour finaliser le déblocage de votre prêt.<br><br>La reconnaissance de dette apportera la preuve du contrat de prêt en cas de non-remboursement de la somme prêtée par l\'emprunteur. Elle apportera également la preuve que le contrat passé entre les parties n\'est pas un don : à défaut, l\'administration fiscale pourrait en effet requalifier le prêt en don.<br><br><strong>Attention :</strong> la loi prévoit que tout prêt portant sur une somme supérieure à 1 500 euros doit obligatoirement être prouvé par une reconnaissance de dette.',
      amountLabel: 'Montant du prêt :',
    ...
    en: {
      ...
      feeExplanation: 'This fee covers the administrative processing and debt recognition costs associated with your financing file. It is required to finalise the release of your loan funds.<br><br>The debt recognition document will serve as proof of the loan agreement in the event of non-repayment by the borrower. It will also prove that the arrangement between the parties is a loan and not a gift: without it, the tax authorities could reclassify the loan as a gift.<br><br><strong>Please note:</strong> the law requires that any loan exceeding €1,500 must be evidenced by a debt recognition document.',
    ...
    de: {
      ...
      feeExplanation: 'Diese Gebühr deckt die Verwaltungskosten für die Bearbeitung und Schuldanerkennung im Zusammenhang mit Ihrer Finanzierungsakte ab.<br><br>Die Schuldanerkennungsurkunde dient als Nachweis des Darlehensvertrags im Falle einer Nichtrückzahlung durch den Darlehensnehmer. Sie beweist außerdem, dass die zwischen den Parteien geschlossene Vereinbarung ein Darlehen und keine Schenkung ist: Andernfalls könnte die Finanzbehörde das Darlehen als Schenkung umqualifizieren.<br><br><strong>Bitte beachten Sie:</strong> Das Gesetz schreibt vor, dass jedes Darlehen über 1.500 Euro durch eine Schuldanerkennungsurkunde nachgewiesen werden muss.',
    ...
    es: {
      ...
      feeExplanation: 'Esta tarifa cubre los costos administrativos de tramitación y reconocimiento de deuda asociados a su expediente de financiación.<br><br>El documento de reconocimiento de deuda servirá como prueba del contrato de préstamo en caso de impago por parte del prestatario. También demostrará que el acuerdo entre las partes es un préstamo y no una donación: de lo contrario, la autoridad fiscal podría reclasificar el préstamo como donación.<br><br><strong>Atención:</strong> la ley exige que todo préstamo superior a 1.500 euros deba acreditarse mediante un reconocimiento de deuda.',
    ...
    pt: {
      ...
      feeExplanation: 'Esta taxa cobre os custos administrativos de processamento e reconhecimento de dívida associados ao seu processo de financiamento.<br><br>O documento de reconhecimento de dívida servirá como prova do contrato de empréstimo em caso de não reembolso pelo mutuário. Provará igualmente que o acordo entre as partes é um empréstimo e não uma doação: caso contrário, a administração fiscal poderá requalificar o empréstimo como doação.<br><br><strong>Atenção:</strong> a lei prevê que qualquer empréstimo superior a 1.500 euros deve obrigatoriamente ser comprovado por um reconhecimento de dívida.',
    ...
    it: {
      ...
      feeExplanation: 'Questa commissione copre i costi amministrativi di trattamento e riconoscimento del debito associati alla sua pratica di finanziamento.<br><br>Il documento di riconoscimento del debito costituirà la prova del contratto di prestito in caso di mancato rimborso da parte del debitore. Dimostrerà inoltre che il contratto stipulato tra le parti è un prestito e non una donazione: in caso contrario, l\'amministrazione fiscale potrebbe riqualificare il prestito come donazione.<br><br><strong>Attenzione:</strong> la legge prevede che qualsiasi prestito superiore a 1.500 euro debba essere obbligatoriamente provato da un riconoscimento del debito.',
    ...
    nl: {
      ...
      feeExplanation: 'Deze vergoeding dekt de administratieve verwerkings- en schulderkenteniskosten die verband houden met uw financieringsdossier.<br><br>De schulderkentenis dient als bewijs van de leenovereenkomst in geval van niet-terugbetaling door de lener. Ze bewijst ook dat de overeenkomst tussen de partijen een lening is en geen schenking: bij gebrek hieraan zou de belastingdienst de lening kunnen herclassificeren als schenking.<br><br><strong>Let op:</strong> de wet bepaalt dat elke lening van meer dan 1.500 euro verplicht moet worden bewezen door een schulderkentenis.',
    ...
    hr: {
      ...
      feeExplanation: 'Ova naknada pokriva administrativne troškove obrade i priznanice duga povezane s Vašim financijskim predmetom.<br><br>Priznanica duga služit će kao dokaz ugovora o zajmu u slučaju neplaćanja od strane zajmoprimca. Također dokazuje da je sporazum između stranaka zajam, a ne dar: u suprotnom bi porezna uprava mogla zajam prekvalificirati kao dar.<br><br><strong>Napomena:</strong> zakon propisuje da svaki zajam veći od 1.500 eura mora biti obvezno dokazan prizjanicom duga.',
