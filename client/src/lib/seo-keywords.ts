...
export function getTermsSEOByLocale(locale: string = 'fr'): { title: string; description: string; keywords: string } {
  const seoByLang = {
    fr: {
      title: 'Conditions Générales d\'Utilisation - KreditPass',
    ...
    en: {
      title: 'Terms of Service - KreditPass',
    ...
    es: {
      title: 'Términos de Servicio - KreditPass',
    ...
    pt: {
      title: 'Termos de Serviço - KreditPass',
    ...
    it: {
      title: 'Condizioni d\'uso - KreditPass',
    ...
    de: {
      title: 'Nutzungsbedingungen - KreditPass',
...
export function getPrivacySEOByLocale(locale: string = 'fr'): { title: string; description: string; keywords: string } {
  const seoByLang = {
    fr: {
      title: 'Politique de Confidentialité - KreditPass',
    ...
    en: {
      title: 'Privacy Policy - KreditPass',
    ...
    es: {
      title: 'Política de Privacidad - KreditPass',
    ...
    pt: {
      title: 'Política de Privacidade - KreditPass',
    ...
    it: {
      title: 'Politica sulla privacy - KreditPass',
    ...
    de: {
      title: 'Datenschutzrichtlinie - KreditPass',
...
export function getProductsSEOByLocale(locale: string = 'fr'): { title: string; description: string; keywords: string } {
  const seoByLang = {
    fr: {
      title: 'Nos Produits de Financement - KreditPass',
    ...
    en: {
      title: 'Our Financing Products - KreditPass',
    ...
    es: {
      title: 'Nuestros Productos de Financiación - KreditPass',
    ...
    pt: {
      title: 'Nossos Produtos de Financiamento - KreditPass',
    ...
    it: {
      title: 'I Nostri Prodotti di Finanziamento - KreditPass',
...
export function getResourcesSEOByLocale(locale: string = 'fr'): { title: string; description: string; keywords: string } {
  const seoByLang = {
    fr: {
      title: 'Ressources et FAQ - KreditPass',
    ...
    en: {
      title: 'Resources and FAQ - KreditPass',
    ...
    es: {
      title: 'Recursos y Preguntas Frecuentes - KreditPass',
    ...
    pt: {
      title: 'Recursos e Perguntas Frequentes - KreditPass',
    ...
    it: {
      title: 'Risorse e Domande Frequenti - KreditPass',
