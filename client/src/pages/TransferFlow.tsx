          ...
          <div className="space-y-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl border border-blue-200 dark:border-blue-800 p-5">
              <h3 className="text-sm font-semibold text-blue-800 dark:text-blue-300 mb-3 flex items-center gap-2">
                ...
                {t.transferFlow.security.helpTitle}
              </h3>
              <div className="space-y-3">
                <div>
                  <p className="text-xs font-semibold text-blue-700 dark:text-blue-300">{t.transferFlow.security.helpIbanTitle}</p>
                  <p className="text-xs text-blue-600 dark:text-blue-400 mt-0.5">{t.transferFlow.security.helpIbanDesc}</p>
                </div>
                <div>
                  <p className="text-xs font-semibold text-blue-700 dark:text-blue-300">{t.transferFlow.security.helpBicTitle}</p>
                  <p className="text-xs text-blue-600 dark:text-blue-400 mt-0.5">{t.transferFlow.security.helpBicDesc}</p>
                </div>
                <div className="bg-blue-100 dark:bg-blue-900/40 rounded-lg px-3 py-2">
                  <p className="text-xs text-blue-700 dark:text-blue-300 italic">{t.transferFlow.security.helpTip}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
              <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2">
                ...
                {t.transferFlow.security.guaranteesTitle}
              </h3>
              <div className="space-y-2">
                {[
                  t.transferFlow.security.guarantee1,
                  t.transferFlow.security.guarantee2,
                  t.transferFlow.security.guarantee3,
                  t.transferFlow.security.guarantee4,
                ].map((g) => (
                  <div key={g} className="flex items-center gap-2">
                    <CheckCircle2 className="h-3.5 w-3.5 text-emerald-500 flex-shrink-0" />
                    <p className="text-xs text-gray-600 dark:text-gray-400">{g}</p>
                  </div>
                ))}
              </div>
            </div>
